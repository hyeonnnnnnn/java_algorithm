...
public class bj_3230 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		ArrayList<Integer> arr1 =new ArrayList<Integer>(); //1번경기
		ArrayList<Integer> arr2 =new ArrayList<Integer>(); //2번경기
		arr1.add(1); //1번지 부터 쓸거라 0번지 초기화
		arr2.add(1);
		...
		//첫번째 경기
		for(int i=1;i<=N;i++) {
			arr1.add(s.nextInt(),i);
		}
		//두번째 경기
		for(int i=M;i>0;i--) {
			arr2.add(s.nextInt(),arr1.get(i));
		}
